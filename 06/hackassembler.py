...
class Command:
    def __init__(self):
        ...
        self.symbol = None       # Only if A-command
        self.destination = None  # Only if A or L-command
        self.computation = None  # Only if C-command
        self.jump = None         # Only if C-command
